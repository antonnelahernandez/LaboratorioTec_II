...
const color = d3.scaleSequential([1.000,600.000],d3.interpolateCool) 
...
d3.select('.mapa').selectAll('path')
    .on('mouseenter', (e, d) => {
        ...
        etiqueta.html(`<p>${d.properties.Comuna}<p> <p>${d.properties.Poblacion}<p>`)
